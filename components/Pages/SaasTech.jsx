          ...
          >
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-gray-200 font-extralight text-sm xs:text-base sm:text-lg ">
                Boost Onboarding, Retention & Support with
        ...
        <div className="w-full max-w-7xl mx-auto px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-800 text-sm sm:text-base md:text-md mb-3  md:text-left">
              ...
              analyzes 100% of customer interactions, giving you instant visibility
              into customer sentiment, compliance, and agent performance that
              too in real time.
            </p>
                  ...
                  <div className="ml-5 space-y-1">
                    {feature.description.map((desc, i) => (
                      <div key={i} className="flex items-start space-x-2">
                        ...
                        <p className="text-gray-300 text-sm sm:text-sm leading-relaxed">{desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      >
        ...
        <div className="w-full md:w-1/2 max-w-xl px-4 md:px-6 flex flex-col items-center md:items-start">
          ...
          <p className="text-gray-800 text-sm sm:text-base md:text-md mb-3  md:text-left">
            ...
            business needs, whether you’re in fintech, healthtech, e-commerce,
            or developer tools.
          </p>
        ...
        <div className="w-full md:w-1/2 max-w-xl px-4 md:px-6 flex flex-col items-center md:items-start">
          ...
          <p className="text-gray-800 text-sm sm:text-base md:text-base mb-3 md:text-left">
            ...
            identify recurring feature requests, sales leaders to track objection
            patterns, and support managers to recognize top-performing
            agents.
          </p>
