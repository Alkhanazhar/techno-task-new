...
const Solutions = () => {
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-24">
        <div
        ...
        <div className="relative mb-3" ref={targetRef}>
          <motion.div
            style={{ height }}
            className="absolute left-1/2 zoom-out transform -translate-x-1/2 w-0.5 bg-gradient-to-r from-[#3F2AB2] via-gray-500 to-[#B462CE] rounded-full hidden lg:block"
          />
