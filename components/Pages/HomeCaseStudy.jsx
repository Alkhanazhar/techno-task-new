        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 xs:gap-10 sm:gap-12 md:gap-14 lg:gap-16 xl:gap-10 min-h-screen py-12 lg:py-0">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left space-y-2 sm:space-y-2">
            <div className="space-y-2 sm:space-y-3 md:space-y-2">
              <h1 className="text-2xl xs:text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-4xl font-bold text-white leading-tight">
                Convoze for
              </h1>
              <h2 className="text-4xl xs:text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-6xl font-bold bg-gradient-to-r from-[#C068D1] to-[#3224AF] text-transparent bg-clip-text leading-tight">
                BPO & Contact Centers
              </h2>
            </div>
