            ...
            >
                ...
                <div className="w-full md:w-1/2 max-w-xl px-4 md:px-6 flex flex-col items-center md:items-start">
                    ...
                    <p className="text-gray-800 text-sm sm:text-base md:text-md mb-3  md:text-left">
                        Convoze empowers financial institutions to build trust and stay compliant — safeguarding every conversation, detecting risks early, and ensuring revenue protection with confidence
                    </p>
                    ...
                    <div className="space-y-2 sm:space-y-3 font-semibold">
                        {[
                            ...
                            "  CInstead of chasing issues after they surface, your teams act early —resolving disputes faster, serving high-value clients with precision, and proving compliance without drowning in manual audit.",
                        ].map((item, idx) => (
                ...
                <div className="w-full md:w-1/2 max-w-xl px-4 md:px-6 flex flex-col items-center md:items-start">
                    ...
                    <p className="text-gray-800 text-sm sm:text-base md:text-base mb-3 md:text-left">
                        Financial institutions face fragmented conversations, compliance risks, and hidden fraud. Convoze turns every interaction into a safeguard — delivering 100% audits, real-time sentiment insights, and multilingual support to boost trust and performance.
                    </p>
                    <div className="space-y-2 sm:space-y-3 font-semibold">
                        {[
            ...
            >
                <div className="w-full max-w-7xl mx-auto px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-4">
                        ...
                        {[
                            ...
                            <div key={index} className="space-y-1 mb-2">
                                ...
                                <p className="text-gray-300 text-sm sm:text-sm leading-relaxed ml-5">{feature.description}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {[
                            {
                                title: "Most conversation intelligence tools only capture fragments",
                                description:
                            ...
                            },
                            {
                                ...
                                description: "Automated QA scoring and insights cut manual review time by 40–60%, helping teams coach and scale faster.",
                            },
                            {
                                title: "Reduced Escalations & Disputes",
                                description: "Full visibility into conversations accelerates dispute resolution, reducing escalations by 20–30%.",
                            },
                            {
                                title: "Actionable Insights for Product & Service Improvements",
                                description: "Frequent issues and feedback surfaced directly from conversations, enabling faster decision-making and 25% faster product/service improvements.",
                            },
                            {
                                title: "Auditing & Operations with Cost Savings",
                                description: "Automating Q&A and monitoring reduces audit costs by 20–25% , Delivering a 20–25% reduction in audit costs.",
                            },
                        ].map((feature, index) => (
                            <div key={index} className="space-y-1 mb-2">
                                <div className="flex items-center space-x-2">
                        ...
                        <p className="text-gray-300 text-sm sm:text-base md:text-md mb-3 md:text-left">
                            With Convoze, every interaction becomes an opportunity to protect trust, reduce risk, and grow your business with confidence.
                        </p>
                    </div>
                </div>
            </motion.div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <p className="text-gray-800 text-sm sm:text-base">Whether you’re managing retail banking, wealth management, or
                                high-value financial support, Convoze fits seamlessly into evey operation .
                                Built to handle high-volume financial institutions, multilingual teams, and any organization where trust,
                                accuracy, and regulatory compliance are critical. From monitoring every conversation to providing
                                real-time insights, With Convoze, your teams can move fast and confidently knowing your customers, brand,
                                and revenue are protected</p>
                        </div>
                    </div>
