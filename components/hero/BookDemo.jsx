const BookDemo = () => {
  return (
    <section className="bg-white shadow-[inset_-12px_-8px_40px_#46464620] md:py-32 sm:min-h-screen  items-center flex py-16 border border-red-600 md:px-8 px-3 relative">
