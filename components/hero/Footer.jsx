  ...
  return (
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/10 pb-10 relative z-10">
        ...
        <button className="bg-gradient-to-r from-[#C068D1] cursor-pointer to-[#3224AF] text-white text-xs md:text-sm font-medium px-5 py-2.5 rounded-full shadow-md hover:scale-105 transition">
          Let’s Work Together
        </button>
      </div>
