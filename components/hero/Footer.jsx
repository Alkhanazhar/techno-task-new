    ...
    <footer className="bg-[#0A0A0A] border-t border-white/10 text-white py-10 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/10 pb-10 relative z-10">
          ...
          <button onClick={() => router.push("/contact")} className="bg-gradient-to-r from-[#C068D1] cursor-pointer to-[#3224AF] text-white text-xs md:text-sm font-medium px-5 py-2.5 rounded-full shadow-md hover:scale-105 transition">
            Let’s Work Together
          </button>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-white/10 pb-10 relative z-10">
          ...
          {/* Location */}
          <div>
            <h4 className="font-semibold mb-2 text-sm md:text-base">Our Location</h4>
            <p className="text-xs md:text-sm text-white/70">123 Ayodhya Bypass Road</p>
            <p className="text-xs md:text-sm text-white/70">Bhopal, India</p>
          </div>
        </div>
