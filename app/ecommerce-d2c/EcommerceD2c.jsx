...
import { Repeat, Gauge, TrendingUp, MessageSquare, DollarSign } from "lucide-react";
        ...
        <div className="w-full max-w-7xl mx-auto px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-800 text-sm sm:text-base md:text-md mb-3  md:text-left">
              In ecommerce and D2C, each customer interaction and support ticket is an opportunity to
              strengthen your brand, boost repeat purchases, and gather insights about your products.
              Most teams only capture a small part of these interactions, missing vital signals that
              affect revenue and customer loyalty
            </p>
            <p className="text-gray-800 text-sm sm:text-base md:text-md mb-3  md:text-left">
              Convoze AI changes that. It audits 100% of conversations across all channels, tracks key
              performance metrics (KPIs) for every interaction, extracts actionable insights in real time,
              and helps your teams respond instantly on what matters most.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-10 lg:px-12 xl:px-16 mb-5">
          ...
          <p className="text-center max-w-3xl mx-auto text-gray-800 text-sm sm:text-base leading-relaxed mb-5">
            Convoze transforms all discussions into valuable insights that drive sales
            growth, enhance customer loyalty, and accelerate product selection.
          </p>
          ...
          <p className="text-center max-w-4xl mx-auto text-gray-800 text-sm sm:text-base leading-relaxed">
            Convoze uses every customer interaction to generate valuable business intelligence
            which enables Ecommerce and D2C brands to maintain customer loyalty
            and boost sales and make better business choices.
          </p>
        </div>
      </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
            ...
            <div>
              ...
              <p className="mt-4 max-w-4xl mx-auto text-gray-300 text-sm sm:text-base leading-relaxed">
                Convoze ensures brands deliver consistent, personalized, and efficient experiences at scale.
              </p>
            </div>
